...
_coldboxElixir2.default.extend('combine', function (src, output, baseDir) {
    var paths = prepGulpPaths(src, baseDir, output);

    new _coldboxElixir2.default.Task('combine', function () {
...
var prepGulpPaths = function prepGulpPaths(src, baseDir, output) {
    return new _coldboxElixir2.default.GulpPaths().src(src, baseDir || '').output(output);
};