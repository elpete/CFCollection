...
_coldboxElixir2.default.extend('browserify', function (src, output, baseDir, options) {
    var paths = prepGulpPaths(src, baseDir, output);

    loadPlugins();

    new _coldboxElixir2.default.Task('browserify', function () {
...
var prepGulpPaths = function prepGulpPaths(src, baseDir, output) {
    return new _coldboxElixir2.default.GulpPaths().src(src, baseDir || config.get('assets.js.folder')).output(output || config.get('public.js.outputFolder'), 'bundle.js');
};
