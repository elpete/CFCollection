...
_coldboxElixir2.default.extend('copy', function (src, output) {
    var paths = new _coldboxElixir2.default.GulpPaths().src(src).output(output);

    new _coldboxElixir2.default.Task('copy', function () {
